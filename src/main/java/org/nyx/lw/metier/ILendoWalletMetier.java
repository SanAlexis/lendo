...
public interface ILendoWalletMetier {
	...
	public Utilisateur addInformation(Utilisateur u,String nom, String prenom, Date date_nais, String lieu_naiss, String nation);
	public Utilisateur addCoordonnee(Utilisateur u, String adresse, String complAdress, String codePostal, String pays, String ville, String telephone);
