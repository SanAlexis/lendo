		...
		<div class="row" id="">
			...
			<div class="col-sm-4" id="" style="background-color:">
				...
				<div class="row" id="">
					...
					<div class="row" id="">
						<h4 class="text-center">Inscrivez vous avec votre adresse
							email</h4>
					</div>
...
<div>
						...
						<div>
							...
							<div class="form-group" id="div-check">
								<p>
									<input type="checkbox" name="" value="" class="" id="check">
				...
				<div class="row" id="">
					<a href="connexion" id='option'><h4 class="text-center">Deja
							inscrit(e)? Connectez vous ici</h4></a>
				</div>
