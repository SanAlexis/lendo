...
<title>Bienvenue sur Lendo, Inscription</title>
...
<body>
	<div class="container" id="">
		...
		<div class="row" id="">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id=""
				...
				<h2 class="text-center">Créez votre compte Lendo</h2>
			</div>
		</div>
		<div class="row" id="">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id=""
		...
		<div class="row" id="">
			<div class="col-sm-offset-4 col-md-offset-4 col-lg-offset-4 col-xs-12 col-sm-2 col-md-2 col-lg-2" id=""
				style="background-color:">
				<h4 class="text-center">FACEBOOK</h4>
			</div>
			<div class="col-sm-offset-0 col-md-offset-0 col-lg-offset-0 col-xs-12 col-sm-2 col-md-2 col-lg-2" id=""
				style="background-color:">
		...
		<div class="row" id="">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id=""
				style="background-color:">
				<h4 class="text-center">Inscrivez vous avec votre adresse email</h4>
			</div>
		</div>
		...
		<form action="" name="" method="post">
			...
			<div class="row" id="">
				...
				<div
					...
					id="" style="background-color:">
					<div class="form-group" id="div-nom">
								<input type="text" name="nom" id="nom" class="form-control"
									placeholder="Veuillez entrer votre nom" /> <span
									class="glyphicon form-control-feedback" id="glyph-nom"></span>
								<span class="help-block" id="error-nom">Votre nom ne doit
									pas être vide</span>
							</div>
							<p>
			...
			<div class="row" id="">
				...
				<div
					class="col-sm-offset-2 col-md-offset-0 col-lg-offset-0 col-xs-12 col-sm-8 col-md-6 col-lg-6"
					id="" style="background-color:">
					<div class="form-group" id="div-prenom">
								<input type="text" name="prenom" id="prenom"
									class="form-control" placeholder="Veuillez entrer votre prénom" />
								<span class="glyphicon  form-control-feedback" id="glyph-nom"></span>
								<span class="help-block" id="error-prenom"></span>
							</div>
				</div>
			</div>
				<!-- CHAMP ADRESSE EMAIL -->
				...
				<div
					...
					<div class="form-group" id="div-email">
								...
								<span class="help-block" id="error-email">Adresse email
									invalide ou deja utilisée</span>
							</div>
							<p>
			...
			<!-- CHAMP CONTRAT D'UTILISATION -->
			<div class="row" id="">
				<div
					class="col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-xs-6 col-sm-5 col-md-5 col-lg-5"
					id="" style="background-color:">
					<label class="control-label">J'ai lu et j'accepte le contrat d'utilisation </label>
				</div>
				<div
			...
			<div class="row" id="">
				...
				<div class="form-group">
								<input type="button" name="" value="Créer mon compte"
			...
			<div class="row" id="">
				<div
					...
					id="" style="background-color:">
					<a href="connexion" id='option'><h4 class="text-center"><label class="control-label">Deja
							inscrit(e)? Connectez vous ici</label></h4></a>
	...
	<script src="<%=request.getContextPath()%>/resources/js/inscription.js"></script>
