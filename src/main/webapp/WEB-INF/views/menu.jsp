		...
		<div class="row" id="menudusite" style="background-color: #652C90">
			<div
			...
			<div class=" col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-xs-12 col-sm-1 col-md-1 col-lg-1"
				...
				<ul class="nav navbar-nav">
					<li class="connecte" ><a href="creerprojet"
						class="glyphicon glyphicon-plus" id="nouveauprojet" style="background-color: ;color:white">Créer</a></li>
			...
			<div class="col-xs-12 col-sm-1 col-md-1 col-lg-1" id=""
				...
				<ul class="nav navbar-nav">
					<li class=""><a href="decouvrir" class=""
						id="parcourir" style="background-color: ;color:white"> Parcourir </a></li>
			...
			<div class="col-xs-12 col-sm-1 col-md-1 col-lg-1" id=""
				...
				<ul class="nav navbar-nav connecte" >
					<li class="dropdown" id="avance1"><a data-toggle="dropdown"
						href="#" class="glyphicon glyphicon-folder-open" style="background-color: ;color:white"><b
							class="caret"></b></a>
			...
			<div class="col-xs-12 col-sm-1 col-md-1 col-lg-1" id=""
				...
				<ul class="nav navbar-nav connecte" id="menu_0">
					<li class="dropdown" id="avance"><a data-toggle="dropdown"
						href="#" class="glyphicon glyphicon-th" style="background-color: ;color:white"><b class="caret"></b></a>
				...
				<ul class="nav navbar-nav deconnecte">
					<li class="dropdown" id="inscription_connexion"><a
						data-toggle="dropdown" href="#" class="glyphicon glyphicon-user" style="background-color: ;color:white"><b
							class="caret"></b></a>
			...
			<div class="col-xs-12 col-sm-1 col-md-1 col-lg-1" id=""
				...
				<ul class="nav navbar-nav connecte">
					<li class="dropdown" id="avance1"><a data-toggle="dropdown"
						href="#" class="glyphicon glyphicon-shopping-cart" style="background-color: ;color:white"><b
							class="caret"></b></a>
